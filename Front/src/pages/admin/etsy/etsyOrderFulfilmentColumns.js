...
export const ETSY_ORDER_FULFILMENT_COLUMNS = [
  ...
  { key: 'dateSold', label: 'Date of Sold', minWidth: 128, align: 'center', section: 'etsy', inputType: 'date' },
  { key: 'etsyOrdersReceivedTime', label: 'Etsy Orders Recived Time', minWidth: 148, align: 'center', section: 'etsy', inputType: 'text' },
  { key: 'shipBy', label: 'Ship By', minWidth: 128, align: 'center', section: 'etsy', inputType: 'date' },
  ...
  { key: 'additionalFees', label: 'Additional Fees', minWidth: 140, align: 'right', section: 'etsy', computed: true },
  { key: 'net', label: 'Net (₹)', minWidth: 120, align: 'right', section: 'etsy', computed: true },
  { key: 'estimateAmazonDelivery', label: 'Estimate Amazon Delivery', minWidth: 188, section: 'amazon', inputType: 'date' },
  { key: 'itemCost', label: 'Amazon Price', minWidth: 120, align: 'right', section: 'amazon', inputType: 'text', format: 'usd' },
  { key: 'shipCost', label: 'Ship Cost', minWidth: 100, align: 'right', section: 'amazon', inputType: 'text', format: 'usd' },
  { key: 'amazonTax', label: 'Tax', minWidth: 88, align: 'right', section: 'amazon', inputType: 'text', format: 'usd' },
  { key: 'totalInUsd', label: 'Total in (USD)', minWidth: 112, align: 'right', section: 'amazon', computed: true, format: 'usd' },
  { key: 'totalInRs', label: 'Total in (Rs)', minWidth: 128, align: 'right', section: 'amazon', computed: true },
  { key: 'markUpFee', label: 'MarkUp Fee', minWidth: 120, align: 'right', section: 'amazon', computed: true },
  { key: 'igst', label: 'IGST', minWidth: 108, align: 'right', section: 'amazon', computed: true },
  { key: 'amazonTotal', label: 'Total', minWidth: 128, align: 'right', section: 'amazon', computed: true },
  { key: 'exRate', label: 'Ex. Rate (₹)', minWidth: 108, align: 'right', section: 'amazon', inputType: 'text' },
  { key: 'inHand', label: 'In Hand', minWidth: 128, align: 'right', section: 'amazon', computed: true, colorBySign: true },
