...
export const PAGE_DEFAULT_ROLES = {
  ...
  // Finance & Cash Flow
  'Payoneer': ['superadmin', 'financemanager'],
  'BankAccounts': ['superadmin', 'financemanager'],
  'Transactions': ['superadmin', 'financemanager'],
  'ExtraExpenses': ['superadmin', 'financemanager'],
  'RevenueGrossNet': ['superadmin', 'financemanager'],
  'Cashflow': ['superadmin', 'financemanager'],
  'Affiliate': ['superadmin', 'financemanager'],
  'Salary': ['superadmin', 'financemanager'],
  ...
  'Meetings': ['superadmin', 'productadmin', 'listingadmin', 'lister', 'advancelister', 'compatibilityadmin', 'compatibilityeditor', 'fulfillmentadmin', 'hradmin', 'hr', 'operationhead', 'trainee', 'hoc', 'compliancemanager', 'financemanager', 'itadmin'],
